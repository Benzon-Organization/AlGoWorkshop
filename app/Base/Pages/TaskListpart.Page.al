...
page 71458594 "BSD Task Listpart"
{
    ApplicationArea = All;
    Caption = 'Tasks';
    ...
    var
        ...
        MakePhoneCallTxt: Label 'The Make Phone Call function for this task is available only on the Attendee Scheduling window.';
        SelectTaskLbl: Label 'You must select a task with a contact assigned to it before you can use the Make Phone Call function.';
